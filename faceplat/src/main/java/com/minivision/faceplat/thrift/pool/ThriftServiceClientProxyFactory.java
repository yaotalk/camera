package com.minivision.faceplat.thrift.pool;
...
import com.minivision.faceplat.thrift.pool.ThriftClientPoolFactory.PoolOperationCallBack;
	...
	public void afterPropertiesSet() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		proxyClient = Proxy.newProxyInstance(classLoader, new Class[] { objectClass }, new InvocationHandler() {
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				throw new IOException("thrift communication error");
			}
		});
	}
